  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <table className="w-py-5 border border-[#DEE5DB] rounded-xl">
        <thead>
          <tr className="">
            <td className="py-2 px-4 w-1/5 font-medium text-[#121712]">
              Order Date
            </td>
            <td className="py-2 px-4 w-1/5 font-medium text-[#121712]">
              Order Number
        ...
        <tbody>
          {orders?.map((item, i) => (
            <tr className="border-t border-[#DEE5DB]">
              <td className="p-4 w-1/5 font-medium text-[#708763] text-[14px]">
              ...
              <td className="p-4 w-1/5 font-medium text-[#708763] text-[14px]">
                <button className="px-4 py-2 rounded-lg bg-[#F2F5F0]">
                  {item.status}
                </button>
              </td>
            </tr>
