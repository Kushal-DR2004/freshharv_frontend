  ...
  return (
    <div className="w-[1280px] px-[160px] py-5">
      <div className="w-[960px]  pb-5">
        <div className="w-[960px]  pt-5 pb-3 px-">
          4
          <h1 className="w-[928px] h-[35px]  font-bold text-[28px] text-[#121712] text-center">
        ...
        <form onSubmit={handleSubmit}>
          <div className=" py-3 px-4 mx-[240px]">
            <input
              className="w-full  rounded-[8px] p-4 bg-[#F2F5F6] font-medium text-[16px] text-[#708763]"
          ...
          <div className=" py-3 px-4 mx-[225.5px] ">
            <button className="w-full px-5 py-3 rounded-[8px] bg-[#4AB814] text-[16px] font-bold text-[#121712] hover:bg-green-600 focus:border">
              Sign Up
            </button>
          </div>
          <div className="w-[960px] px-4 pt-1 pb-3">
            <p className=" text-[14px] font-medium text-[#708763] text-center">
